...
class Home_VC: UIViewController {
    ...
    func setCellsConfigurations(){
        ...
        categoriesCollectionView.register(UINib(nibName: Constant.CELL_CATEGORIES, bundle: nil), forCellWithReuseIdentifier: Constant.CELL_CATEGORIES)

        popularNowCollectionView.register(UINib(nibName: Constant.CELL_POPULAR_NOW, bundle: nil), forCellWithReuseIdentifier: Constant.CELL_POPULAR_NOW)
        
        trendingCollectionView.register(UINib(nibName: Constant.CELL_TRENDING, bundle: nil), forCellWithReuseIdentifier: Constant.CELL_TRENDING)
    ...
    func bindResturants(){
        ...
        viewModel.getData(url: URLCreator().getPopular(lat: 29.1931, lng: 30.6421))
    }
}
...
extension Home_VC : UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        switch collectionView.tag {
            case 0:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constant.CELL_CATEGORIES, for: indexPath) as! CategoriesCell
            
            cell.img.kf.setImage(with: URL(string: categories[indexPath.row].image))
            cell.categoryName.text = categories[indexPath.row].name
            return cell
            case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constant.CELL_POPULAR_NOW, for: indexPath) as! PopularNowCell
            ...
            return cell
            case 2:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constant.CELL_TRENDING, for: indexPath) as! TrendingNowCell
